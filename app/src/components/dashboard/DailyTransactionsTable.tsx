                    ...
                    <tbody>
                        {sortedData.length > 0 ? (
                            sortedData.map((day, index) => {
                                ...
                                // Positive means we spent MORE than yesterday (Bad -> Red)
                                // Negative means we spent LESS than yesterday (Good -> Green)
                                ...
                                return (
                                    <tr
                                        ...
                                        className="border-b border-[var(--color-border)] last:border-0 hover:bg-[var(--color-surface-hover)] transition-colors cursor-pointer"
                                    >
